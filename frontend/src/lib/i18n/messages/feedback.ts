...
export const feedback = {
  en: {
    ...
    "feedback.error.partial": "Your feedback was only partly saved. Please try sending it again.",
  ...
  ru: {
    ...
    "feedback.error.partial": "Ваш отзыв сохранён лишь частично. Пожалуйста, отправьте его снова.",
  ...
  fr: {
    ...
    "feedback.error.partial": "Votre retour n'a été enregistré qu'en partie. Veuillez le renvoyer.",
