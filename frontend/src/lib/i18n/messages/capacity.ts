...
export const capacity = {
  en: {
    ...
    "capability.activeUsers": "Active users on this backend: {count}",
  ...
  de: {
    ...
    "capability.activeUsers": "Aktive Nutzer auf diesem Backend: {count}",
  ...
  gsw: {
    ...
    "capability.activeUsers": "Aktivi Nutzer uf däm Backend: {count}",
  ...
  ru: {
    ...
    "capability.activeUsers": "Активных пользователей на этом бэкенде: {count}",
  ...
  es: {
    ...
    "capability.activeUsers": "Usuarios activos en este backend: {count}",
  ...
  fr: {
    ...
    "capability.activeUsers": "Utilisateurs actifs sur ce backend : {count}",
  ...
  it: {
    ...
    "capability.activeUsers": "Utenti attivi su questo backend: {count}",
