...
export const onboarding = {
  en: {
    ...
    "ai.status.nonAiNote": "All non-AI features stay usable: grades, statistics, materials and planning.",
  ...
  de: {
    ...
    "onboarding.language.mustChoose": "Wähle eine Sprache, um fortzufahren, oder überspringe die Sprachauswahl.",
    "ai.status.nonAiNote": "Alle Funktionen ohne KI bleiben nutzbar: Noten, Statistiken, Materialien und Planung.",
  ...
  gsw: {
    ...
    "onboarding.language.mustChoose": "Wähl e Sprach zum witerfahre oder überspring die Sprachuuswahl.",
    "ai.status.nonAiNote": "Alli Funktione ohni KI blibe nutzbar: Note, Statistike, Material und Planig.",
  ...
  ru: {
    ...
    "onboarding.language.mustChoose": "Выберите язык, чтобы продолжить, или пропустите выбор языка.",
    "ai.status.nonAiNote": "Все функции без ИИ остаются доступными: оценки, статистика, материалы и планирование.",
  ...
  es: {
    ...
    "onboarding.language.mustChoose": "Elige un idioma para continuar o salta la selección de idioma.",
    "ai.status.nonAiNote": "Todas las funciones sin IA siguen disponibles: notas, estadísticas, materiales y planificación.",
  ...
  fr: {
    ...
    "onboarding.language.mustChoose": "Choisis une langue pour continuer ou passe la sélection de la langue.",
    "ai.status.nonAiNote": "Toutes les fonctions sans IA restent utilisables : notes, statistiques, documents et planification.",
  ...
  it: {
    ...
    "onboarding.language.mustChoose": "Scegli una lingua per continuare oppure salta la selezione della lingua.",
    "ai.status.nonAiNote": "Tutte le funzioni senza IA restano utilizzabili: voti, statistiche, materiali e pianificazione.",
