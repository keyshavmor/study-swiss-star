...
export const system = {
  en: {
    ...
    "systemHealth.myData.peerAttachments": "Message attachments",
    "systemHealth.myData.assistantMessages": "Assistant messages",
    "systemHealth.myData.assistantAttachments": "Assistant attachments",
    "systemHealth.myData.studyChatMessages": "Study chat messages",
    "systemHealth.myData.plannerEvents": "Planner entries",
    "systemHealth.myData.feedbackItems": "Feedback sent",
  ...
  de: {
    ...
    "systemHealth.myData.peerAttachments": "Nachrichtenanhänge",
    "systemHealth.myData.assistantMessages": "Assistenz-Nachrichten",
    "systemHealth.myData.assistantAttachments": "Assistenz-Anhänge",
    "systemHealth.myData.studyChatMessages": "Lernchat-Nachrichten",
    "systemHealth.myData.plannerEvents": "Planereinträge",
    "systemHealth.myData.feedbackItems": "Gesendetes Feedback",
  ...
  gsw: {
    ...
    "systemHealth.myData.peerAttachments": "Nachrichte-Aahäng",
    "systemHealth.myData.assistantMessages": "Assistänz-Nachrichte",
    "systemHealth.myData.assistantAttachments": "Assistänz-Aahäng",
    "systemHealth.myData.studyChatMessages": "Lernchat-Nachrichte",
    "systemHealth.myData.plannerEvents": "Planer-Iiträg",
    "systemHealth.myData.feedbackItems": "Gschickts Feedback",
  ...
  ru: {
    ...
    "systemHealth.myData.peerAttachments": "Вложения в сообщениях",
    "systemHealth.myData.assistantMessages": "Сообщения ассистента",
    "systemHealth.myData.assistantAttachments": "Вложения ассистента",
    "systemHealth.myData.studyChatMessages": "Сообщения учебного чата",
    "systemHealth.myData.plannerEvents": "Записи планировщика",
    "systemHealth.myData.feedbackItems": "Отправленные отзывы",
  ...
  es: {
    ...
    "systemHealth.myData.peerAttachments": "Adjuntos de mensajes",
    "systemHealth.myData.assistantMessages": "Mensajes del asistente",
    "systemHealth.myData.assistantAttachments": "Adjuntos del asistente",
    "systemHealth.myData.studyChatMessages": "Mensajes del chat de estudio",
    "systemHealth.myData.plannerEvents": "Entradas del planificador",
    "systemHealth.myData.feedbackItems": "Comentarios enviados",
  ...
  fr: {
    ...
    "systemHealth.myData.peerAttachments": "Pièces jointes des messages",
    "systemHealth.myData.assistantMessages": "Messages de l'assistant",
    "systemHealth.myData.assistantAttachments": "Pièces jointes de l'assistant",
    "systemHealth.myData.studyChatMessages": "Messages du chat de révision",
    "systemHealth.myData.plannerEvents": "Entrées du planificateur",
    "systemHealth.myData.feedbackItems": "Retours envoyés",
  ...
  it: {
    ...
    "systemHealth.myData.peerAttachments": "Allegati dei messaggi",
    "systemHealth.myData.assistantMessages": "Messaggi dell'assistente",
    "systemHealth.myData.assistantAttachments": "Allegati dell'assistente",
    "systemHealth.myData.studyChatMessages": "Messaggi della chat di studio",
    "systemHealth.myData.plannerEvents": "Voci del planner",
    "systemHealth.myData.feedbackItems": "Feedback inviati",
