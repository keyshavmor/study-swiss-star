  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Diagnostics — Alim's Study Assistant" },
      {
        ...
        content: "Prototype status of indexing, sync and AI services.",
      },
  ...
  component: () => (
    <AppShell>
      <PageNav
        ...
        crumbs={[{ label: "Home", to: "/home" }, { label: "Diagnostics" }]}
      />
      <PageHeading title="Diagnostics" description="Simulated service status for the prototype." />
      <SuccessState
        heading="All services nominal"
        description="Indexing, planner sync and chat are responding normally."
      />
    </AppShell>
  ),
});
