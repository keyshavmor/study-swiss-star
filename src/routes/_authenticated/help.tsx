...
export const Route = createFileRoute("/_authenticated/help")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How study material, grades and study plans work in Alim's Study Assistant." },
  ...
  component: () => (
    <AppShell>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {[
          ["How material indexing works", "Upload notes, syllabi and grading criteria; they are indexed for study modes."],
          ["Swiss grading", "Grade = 1.0 + 5.0 × (achieved points ÷ maximum points), from 1.0 to 6.0."],
