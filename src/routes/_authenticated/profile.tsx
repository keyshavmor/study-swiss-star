            ...
            <div className="grid grid-cols-[auto_minmax(0,1fr)] items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-[14.5px] text-muted-foreground">
                  {profile.className
                    ? `Class ${profile.className} · ${yearLabel}`
                    : yearLabel}
                </p>
                {profile.schoolName && (
        ...
        <aside className="flex h-fit flex-col gap-5 lg:sticky lg:top-24">
          <Section title={`Academic summary · ${year.label}`}>
            <Row
              label="Year average"
              value={
                summary.exactYearAverage === null ? "—" : summary.exactYearAverage.toFixed(2)
              }
            />
            <Row
              label="Rounded average"
              value={
                summary.roundedYearAverage === null
                  ? "—"
                  : summary.roundedYearAverage.toFixed(1)
              }
            />
