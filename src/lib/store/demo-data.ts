...
const DEMO_ASSESSMENTS: Assessment[] = [
  ...
  a("sb1", "spf-biology", "Neurobiology test", "Written exam", "2026-09-09", null, 5.5, "Neurobiology"),
  a("sb2", "spf-biology", "Evolution essay", "Essay", "2026-09-23", null, 5.0, "Evolution"),
  a("sb3", "spf-biology", "Genetics laboratory", "Laboratory work", "2026-10-07", null, 5.5, "Genetics"),
  a("sb4", "spf-biology", "Ecology field study", "Project", "2026-10-21", null, 5.5, "Ecology"),
  a("sb5", "spf-biology", "Immunology test", "Written exam", "2026-11-04", null, 5.0, "Immunology"),
  a("sc1", "spf-chemistry", "Organic chemistry test", "Written exam", "2026-09-16", null, 5.5, "Organic"),
  a("sc2", "spf-chemistry", "Titration practical", "Laboratory work", "2026-09-30", null, 5.0, "Titration"),
  a("sc3", "spf-chemistry", "Reaction kinetics", "Written exam", "2026-10-14", null, 5.0, "Kinetics"),
  a("sc4", "spf-chemistry", "Thermodynamics test", "Written exam", "2026-11-11", null, 4.75, "Thermodynamics"),
  a("ec1", "economics", "Markets and pricing", "Written exam", "2026-09-25", [34, 42], null, "Markets"),
  a("ar1", "art", "Portfolio review", "Project", "2026-10-09", null, 5.5, "Portfolio"),
  a("sp1", "sport", "Endurance assessment", "Practical assessment", "2026-09-18", null, 5.0, "Endurance"),
