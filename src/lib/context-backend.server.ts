...
export function contextBackendMode(): "context" | "lovable" {
  return process.env["ALIM_AI_BACKEND"] === "lovable" ? "lovable" : "context";
}

export function lovableFallbackEnabled(): boolean {
  return process.env["ALIM_ENABLE_LOVABLE_FALLBACK"] === "true";
}
