...
| `12-ai-study-tools.mmd` | Quiz / mock exam / grading / study plan surfaces — backend not implemented. | subject workspace tools; `FUTURE CODEX IMPLEMENTATION` |
...
`DEPRECATED`: Diagnostics route · Contact-support CTA · "View demo
